...
class Program
{
    static void Main(string[] args)
    {
        ...
        Reception reception = new Reception("Recital Meet & Greet", "Beginner arrangment showcase and mingling with performers,", "5 Aug 2026", "8:00 PM", address2, "rsvp@pianoclub.com");
